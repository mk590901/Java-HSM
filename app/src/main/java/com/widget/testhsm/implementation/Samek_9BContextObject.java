...
//	public boolean OnInit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnInit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS2Entry(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS2Entry is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS2Exit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS2Exit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS2Init(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS2Init is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS2c(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS2c is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS2f(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS2f is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS21Entry(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS21Entry is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS21Exit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS21Exit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS21Init(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS21Init is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS21b(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS21b is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS21h(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS21h is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS211Entry(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS211Entry is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS211Exit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS211Exit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS211g(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS211g is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1Entry(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1Entry is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1Exit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1Exit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1Init(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1Init is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1b(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1b is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1c(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1c is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1f(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1f is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1a(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1a is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS1d(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS1d is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS11Entry(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS11Entry is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS11Exit(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS11Exit is done [%s]", String.valueOf(data)));
//		return result;
//	}
//
//	public boolean OnS11g(Object data) {
//		boolean result = false;
//		logger_.trace(String.format("OnS11g is done [%s]", String.valueOf(data)));
//		return result;
//	}
//}
